...
/* harmony export */   "modalWision": function() { return /* binding */ modalWision; },
/* harmony export */   "modalHide": function() { return /* binding */ modalHide; }
/* harmony export */ });
...
function sendMessage(modalSelector, timerModalOpen, form) {
  ...
  function sendMessage(form) {
    form.addEventListener('submit', event => {
      ...
      (0,_workfunc_data__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', jsonObj).then(response => {
...
/* harmony import */ var _modules_sendMessage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sendMessage */ "./js/modules/sendMessage.js");
...
window.addEventListener("DOMContentLoaded", () => {
  const timerModalOpen = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.modalWision)("[data-modal]", timerModalOpen), 1000 * 50);
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_1__.default)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__.default)(".menu .container");
  (0,_modules_mainSlider__WEBPACK_IMPORTED_MODULE_3__.default)({
